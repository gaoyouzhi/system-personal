...
public class RestTemplateUtils {
    ...
    /**
     * POST请求调用方式,json请求
     * ResponseEntity<JSONObject> response = restTemplateUtils.post(url, sendShortMessage, JSONObject.class);
     * @param url 请求URL
    ...
    /**
     * 通用调用方式
     * 下载文件,返回文件字节流:restTemplateUtils.exchange(url, HttpMethod.GET, null, byte[].class);
     * 
     * @param url 请求URL
     * @param method 请求方法类型
     * @param requestEntity 请求头和请求体封装对象
