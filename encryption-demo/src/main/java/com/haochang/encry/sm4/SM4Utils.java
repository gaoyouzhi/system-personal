package com.haochang.encry.sm4;
...
//    private boolean hexString = false;
    ...
    public String encryptData_ECB(String plainText) {
        try {
            ...
            byte[] keyBytes;
            if (hexString) {
                keyBytes = HexByteUtil.hexStringToBytes(secretKey);
            } else {
            ...
            return HexByteUtil.byteToHex(encrypted);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    public String decryptData_ECB(String cipherText) {
        try {
            byte[] encrypted = HexByteUtil.hexToByte(cipherText);
    ...
    public String encryptData_CBC(String plainText) {
        try {
            ...
            if (hexString) {
                keyBytes = HexByteUtil.hexStringToBytes(secretKey);
                ivBytes = HexByteUtil.hexStringToBytes(iv);
            } else {
                keyBytes = secretKey.getBytes();
                ivBytes = iv.getBytes();
            }
    ...
    public static void main(String[] args) throws IOException {
        ...
        String s = HexByteUtil.byteToHex(plainText.getBytes());
